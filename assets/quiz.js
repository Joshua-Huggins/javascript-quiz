...
// All global var needed for the actual functions
// Look to see if there is a way to be a bit more cleaner then currently is
var timeLeft = 60;
var timerID;
...
// Countdown timer
// if bumping up the amount of questions go back and add time to timeleft variable 
function timeTick() {
    timeLeft--;
...
// Go to next question
// should keep the next question from being used again
...
function selectAnswer(e) {
    ...
    // Conditional statements to see if answer is right or wrong, if wrong remove 5 seconds
    if (correct) {
...
// If there is extra time figure out how to show the user chosen input as well. 
